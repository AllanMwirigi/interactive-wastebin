...
ap.add_argument("-m", "--model", required=False, default="/media/allan/SharedVolume/Edx/5th Year/Project/InteractiveWasteBin/mcu/camera/models/MobileNetSSD_deploy.caffemodel",
	help="path to Caffe pre-trained model")
ap.add_argument("-c", "--confidence", type=float, default=0.2,
	help="minimum probability to filter weak detections")
ap.add_argument("-mW", "--montageW", required=False, type=int, default=1,
	help="montage frame width")
ap.add_argument("-mH", "--montageH", required=False, type=int, default=1,
